...
class CommDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.relabel:
            ...
            return img, pid_agg, rescamid, 1, img_path, self.domains[domain], self.demains[domain][camid], captions
        else:
            return img, pid, camid, 1, img_path, self.domains[domain], self.demains[domain][camid], captions
    @property
